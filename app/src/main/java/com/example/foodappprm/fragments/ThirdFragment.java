...
public class ThirdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        featuredModelList.add(new FeaturedModel(R.drawable.fav2, "Featured 1", "Description 1"));
        featuredModelList.add(new FeaturedModel(R.drawable.fav1, "Featured 2", "Description 2"));
