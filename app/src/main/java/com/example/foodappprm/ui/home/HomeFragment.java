...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Khởi tạo và hiển thị danh mục (category)
        RecyclerView homeRecyclerView = root.findViewById(R.id.homeRecyclerView);
        List<Category> categories = new ArrayList<>();
        categories.add(new Category("cat_1", "Hamburgers", "hamburger"));
        categories.add(new Category("cat_2", "Pizza", "pizza"));
        categories.add(new Category("cat_3", "Sandwiches", "sandwich"));
        categories.add(new Category("cat_4", "Ice Cream", "ice_cream"));
        categories.add(new Category("cat_5", "French Fries", "fried_potatoes"));
        CategoryAdapter categoryAdapter = new CategoryAdapter(categories, category -> {
            // Xử lý khi click vào category nếu muốn
        });
        ...
        // Khởi tạo và hiển thị danh sách sản phẩm (product)
